...
g.toc = {
	...
	"heDescription": "<span class='dedication'>לעילוי נשמת אמנו, סבתנו, וסבתא רבתא שלנו מרים רייכנער<br>נדבת משפחת רובינשטיין<br>טורונטו, קנדה ורעננה, ישראל<span class='dedication'>"}
